...
def sample_sdf_near_surface(
    ...
    # mesh = scale_to_unit_sphere(mesh) # this should be done outside of this function, because we want to do for all meshes at once based on anchor mesh or the largest mesh
